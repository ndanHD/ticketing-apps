...
<head>
    ...
    <style>
        .hero {
            background: linear-gradient(90deg, #0d6efd66, #6f42c166);
            color: #fff;
            padding: 4rem 0 6rem;
        }
...
<header class="hero text-center">
    <div class="container">
        <h1 class="display-5 fw-bold">Welcome back to Kawano Ticketing</h1>
        <p class="lead mb-4">Sign in to continue managing and tracking tickets.</p>
    </div>
</header>
