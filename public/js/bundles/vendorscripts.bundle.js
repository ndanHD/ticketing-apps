        ...
        slimScroll: function (E) {
            ...
            return this.each(function () {
                ...
                if (p.parent().hasClass(k.wrapperClass)) {
                    ...
                    }), y(), "bottom" === k.start ? (b.css({
                        top: p.outerHeight() - b.outerHeight()
                    }), x(0, !0)) : "top" !== k.start && (x(T(k.start).position().top, null, !0), k.alwaysVisible || b.hide()), g = this, window.addEventListener ? (g.addEventListener("DOMMouseScroll", w, !1), g.addEventListener("mousewheel", w, !1)) : document.attachEvent("onmousewheel", w)
                }
                ...
                function x(e, t, i) {
                    ...
                    if (t && (n = parseInt(b.css("top")) + e * parseInt(k.wheelStep) / 100 * b.outerHeight(), n = Math.min(Math.max(n, 0), s), n = 0 < e ? Math.ceil(n) : Math.floor(n), b.css({
                        top: n + "px"
                    })), n = (r = parseInt(b.css("top")) / (p.outerHeight() - b.outerHeight())) * (p[0].scrollHeight - p.outerHeight()), i) {
                ...
                function y() {
                    a = Math.max(p.outerHeight() / p[0].scrollHeight * p.outerHeight(), c), b.css({
                        height: a + "px"
                    });
    ...
    function (e, t) {
        ...
        return t.init = function (e) {
            ...
            for (var t = {
                type: "mouseup",
                button: 1
            }, i = 0, n = (e = c(e)).length; i < n; i++) u.hide(t, e[i])
                ...
                liveSearchListener: function () {
                    ...
                    this.$button.on("click.dropdown.data-api", function () {
                        ...
                        if (s.$lis.not(".is-hidden").removeClass("hidden"), s.$lis.filter(".active").removeClass("active"), o.remove(), s.$searchbox.val()) {
                            ...
                            if ((e = s.options.liveSearchNormalize ? t.not(":a" + s._searchStyle() + '("' + a(s.$searchbox.val()) + '")') : t.not(":" + s._searchStyle() + '("' + s.$searchbox.val() + '")')).length === t.length) o.html(s.options.noneResultsText.replace("{0}", '"' + k(s.$searchbox.val()) + '"')), s.$menuInner.append(o), s.$lis.addClass("hidden");
                            else {
                                e.addClass("hidden");
